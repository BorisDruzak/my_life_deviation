...
// Immutable AVL tree. Updating a page copies O(log N) nodes per changed key, not the history.
// Payloads and untouched subtrees are shared; older LocalViews and copied memories stay stable.
