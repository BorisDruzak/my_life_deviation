...
struct Information {
    ...
    template<class A>void fields(A& a){a(id,kind,subject,other,location,confidence,valence,material,importance,sensitivity,disclosure,origin,cited_source,occurred_at);}
};
struct MemoryDetail {
