...
struct Seed {
    ...
    std::string random_namespace{}; // Stable cohort keys, independent of additive runtime catalogue changes.
    ...
    template<class A> void fields(A& a) {a(value,generator,catalog,random_namespace);}
};
}
