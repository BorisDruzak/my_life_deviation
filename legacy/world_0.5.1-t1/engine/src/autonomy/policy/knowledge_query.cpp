...
BeliefResult query_belief(const LocalView& view,const BeliefQuery& q,
    ...
    if (bucket) bucket->visit(limit,[&](const Id&,const Id& id) {
        ...
        // Legacy WORLD-0.5 marks these mutable snapshots as open-ended. Preserve the record,
        // but interpret "seen then" as a point observation, not permanent current availability.
        ...
        // A confidence below 0.5 is not evidence for the opposite polarity. Absence is never false.
