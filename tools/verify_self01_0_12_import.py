"""Validate the tracked SELF-0.1 / 0.12 source mapping."""
...
def main() -> int:
    ...
    parser.add_argument(
        "--manifest",
        type=Path,
        default=Path("provenance/incoming/self01_0.12/mapped-source-files.json"),
    )
    ...
    if errors:
        for error in errors:
            print(error)
        return 1
    print("SELF-0.1 / 0.12 import provenance valid")
    return 0
