...
Следующий этап — T2. Историческая локальная ветка разработки: `t1/local-policy-state`; нормализованная поставка T1 опубликована в GitHub `main`.

`SHA256SUMS` и `REPOSITORY_MANIFEST.json` описывают текущую нормализованную репозиторную поставку. Исторические delivery-manifest файлы T0/T1 остаются в архивных поставках, а отчёты предыдущих этапов
