...
`SHA256SUMS` описывает текущие файлы; исходный список сохранён в
`reports/implementation/T0/baseline_SHA256SUMS.txt`. `AUTONOMY_REVIEW_MANIFEST.json` исторический,
для предыдущего архива; текущий срез описан в `T0_IMPLEMENTATION_MANIFEST.json`.
